...
load(file = "data/Achi_mille_grassSamples_20180920.Rdata") ## pre-processed
...
## JAGS model
######################################
sink('scripts/JAGS/JAGS_v0.2_NPMSeg2.txt')
cat("
    model{
    ## State model
...
jagsModel <- jags.model(file= 'scripts/JAGS/JAGS_v0.2_NPMSeg2.txt', data = Data, inits = inits.fn, n.chains = 3, n.adapt= 500)
